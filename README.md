...
---
# 1. Difference between AWS IAM User and IAM role
# 1-1. IAM User
...
# 1-2. IAM role
If you want to create the EC2 instance which sends Emails with AWS SES, IAM role is a good solution for it instead of IAM User's Access Key.
