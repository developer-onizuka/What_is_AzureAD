...
- You don’t need to expose any credentials in your code if you use "Managed Id" which manages the creation and automatic renewal of service principal on your behalf.
